    ...
    public class Configuration : DbMigrationsConfiguration<BooksContext>
    {
        ...
        protected override void Seed(BooksContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                var noviUser = context.Users.Add(new IdentityUser("domagoj") { Email = "domagoj.sucic@omega-software.hr", EmailConfirmed = true });
                noviUser.Roles.Add(new IdentityUserRole { RoleId = userRoleId });
                ...
                store.SetPasswordHashAsync(noviUser, new BookUserManager().PasswordHasher.HashPassword("omega12345"));
            }
